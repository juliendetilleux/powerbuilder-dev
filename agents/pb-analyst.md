...
name: pb-analyst
description: >
  Use this agent when you need deep analysis of PowerBuilder objects — exploring inheritance chains,
  dependency graphs, call graphs, and architecture patterns. Use for questions like "what does w_xxx do?",
  "who calls function of_xxx?", "what inherits from uo_datawindow?", or "show me the full dependency
  tree of this object". This agent works autonomously and returns a structured analysis report.
model: sonnet
color: cyan
